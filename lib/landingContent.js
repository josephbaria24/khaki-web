...
export const LANDING_STEPS = [
  { num: "1", title: "I-describe kung ano'ng kailangan gawin", desc: "Errands, transport, repairs, tours — i-post mo ang Palawan task mo in minutes.", image: "/images/how-it-works/1.png?v=2" },
  { num: "2", title: "I-set ang budget mo", desc: "Ikaw mag-name ng price. Magse-send ng bids ang local taskers, so ikaw pa rin ang in control.", image: "/images/how-it-works/2.png?v=2" },
  { num: "3", title: "Piliin ang best tasker", desc: "I-compare ang ratings, mag-chat, tapos mag-usap kayo sa payment — hindi hawak ni Khaki ang task fee.", image: "/images/how-it-works/3.png?v=2" },
];
